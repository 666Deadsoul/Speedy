...
<body>
    ...
    <section id="parent">
        <section class="first">
            <div class="content">
                <div class="textB">
                    <h2>Unlock your typing POTENTIAL with <span>Speedy</span><br> - The key to more efficient typing
                    </h2>
                    <p>Speedy is a skill development platform that helps a user to enhance their typing skills. Speedy
                ...
                <div class="imgB">
                    <img src="bloom-man-with-headphones-is-typing-on-a-laptop.gif" class="keyboard">
                </div>
            </div>
        </section>
    ...
    <section class="services">
        ...
        <div class="row">
            <div class="p">
                <img src="test1.png" id="ts">
                <h3>Typing Tests</h3>
                <p>Speedy provides timed
            ...
            <div class="p">
                <img src="perf1.png" id="per">
                <h3>Performance Tracking</h3>
                <p> Speedy offers progress tracking
            ...
            <div class="p">
                <img src="tips1.png">
                <h3>Typing Tips</h3>
                <p>Speedy offer typing tips and resources to
            ...
            <div class="p">
                <img src="exe.png" id="ex">
                <h3>Exercises</h3>
                <p>Speedy provide training
    ...
    <footer>
        <div class="roww">
            <div class="g">
                <p class="para">We are glad to have you on our website. Speedy is a free site which enables you to unlock your hidden potentials. So, feel 
            ...
            <div class="g">
                ...
                <p>Kathmandu, Nepal</p>
                <p>+977 9869212116</p>
                <p>speedy@gmail.com</p>
            </div>
            <div class="g" id="di" <?php if (isset($_SESSION['user_id'])) echo 'style="display: none;"'; ?>>
                <h5>Sign Up for Free !!</h5>
                <button><a href="loginpage.php">Start now <i class="fa fa-arrow-right"></i></a></button>
            </div>
